...
export const ExportImportModal: React.FC<ExportImportModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4">
      <div 
        id="modal-backup"
        className="bg-white dark-brushed-metal-modal rounded-2xl max-w-md w-full shadow-2xl border border-slate-200 dark:border-white/10 overflow-hidden animate-in fade-in zoom-in-95 duration-150 text-slate-900 dark:text-slate-100"
      >
        ...
        <div className="p-6 space-y-4">
          ...
          {/* Export card */}
          <div className="p-4 rounded-xl border border-slate-200 dark:border-white/10 bg-slate-50 dark-subcard flex items-center justify-between gap-3">
            <div>
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-2 text-xs font-semibold rounded-lg text-slate-800 dark:text-slate-200 bg-white dark:bg-white/5 hover:bg-slate-100 dark:hover:bg-white/10 border border-slate-200 dark:border-white/10 shadow-xs transition-colors shrink-0 cursor-pointer"
            >
              ...
              <div className="p-3 bg-rose-50 dark:bg-rose-950/50 rounded-xl border border-rose-200 dark:border-rose-900 text-xs">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 bg-white dark:bg-white/10 text-slate-700 dark:text-slate-300 rounded-lg font-medium border border-slate-200 dark:border-white/10 hover:bg-slate-50 dark:hover:bg-white/20 cursor-pointer"
                  >
                    Cancelar
                  </button>
                </div>
